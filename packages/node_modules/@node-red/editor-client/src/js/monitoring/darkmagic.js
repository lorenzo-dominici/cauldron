RED.monitoring = (function () {
    ...
    function redrawLastMessages(nodeId, eventType) {
        ...
        if (eventMessages.length > 0) {
            ...
            value = 
            RED.monitoring.view.updateHTMLNode(nodeId, eventMessages[eventMessages.length - 1].y, eventMessages[eventMessages.length - 1].x, eventType, 0);
    ...
    function findAttr(obj, attributes, pos = 0){
        if(Array.isArray(attributes)){
            if(obj == undefined || pos >= attributes.length)    
                ...
                return findAttr(obj[attributes[pos]], attributes, pos+1);
        } else {
