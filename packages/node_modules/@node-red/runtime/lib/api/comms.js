...
var api = module.exports = {
    init: function(_runtime) {
        ...
        // CAULDRON BEGIN
        events.removeListener("monitoring",handleMonitoringEvent);
        events.on("monitoring",handleMonitoringEvent);

        events.removeListener("breakpoint",handleBreakpointEvent);
        events.on("breakpoint",handleBreakpointEvent);
        // CAULDRON END
    },
