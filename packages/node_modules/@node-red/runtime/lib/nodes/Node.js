...
// CAULDRON BEGIN
var events = require("@node-red/util").events;
// CAULDRON END
...
Node.prototype.toggleDebug = function () {
    this.cauldronDebug = !this.cauldronDebug;
...
Node.prototype.removeDebug = function (){
    this.cauldronDebug =  false;
    this.consumeQueue();
}
